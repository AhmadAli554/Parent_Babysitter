...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { location: @parent.location, name: @parent.name, no_chidren: @parent.no_chidren } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { location: @parent.location, name: @parent.name, no_chidren: @parent.no_chidren } }
