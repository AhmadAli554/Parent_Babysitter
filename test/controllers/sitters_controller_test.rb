...
class SittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sitter" do
    assert_difference('Sitter.count') do
      post sitters_url, params: { sitter: { location: @sitter.location, name: @sitter.name, years_experience: @sitter.years_experience } }
    end
  ...
  test "should update sitter" do
    patch sitter_url(@sitter), params: { sitter: { location: @sitter.location, name: @sitter.name, years_experience: @sitter.years_experience } }
